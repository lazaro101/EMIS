...
body {
  background:linear-gradient(rgba(200,200,200,0.7),rgba(200,200,200,0.75)),url("generalpics/parbg.jpg") center no-repeat;
  height:100vh;
}
div.login {
  position:absolute;
...
.login .banner {
  ...
  width:100%;
  height:210px;
  background:linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.4)),url("/generalpics/parbg1.jpg") center no-repeat;
